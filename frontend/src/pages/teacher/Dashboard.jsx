...
import { FilePlus2, HandCoins, CheckCircle2, StickyNote, User2, Cross, X } from 'lucide-react';
  ...
  return (
    <div className="min-h-[90vh] w-full font-sans">
      ...
      <div className="mb-8">
        ...
        <p className="text-neutral-500 text-base md:text-lg">Teacher Dashboard</p>
      </div>
